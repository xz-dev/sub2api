...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"openai rerank", EndpointRerank, "/v1/rerank", service.PlatformOpenAI, EndpointRerank},
		{"openai prefixed rerank", EndpointRerank, "/openai/v1/rerank", service.PlatformOpenAI, EndpointRerank},
